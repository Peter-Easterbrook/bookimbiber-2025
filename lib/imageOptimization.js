...
// expo-file-system removed to avoid duplicate native module conflict with react-native-appwrite
...
export class ImageCacheManager {
  ...
  async getCacheStats() {
    try {
      ...
      let totalSize = 0;
      let totalFiles = cacheKeys.length;
      ...
      for (const key of cacheKeys) {
        ...
        if (metadata.timestamp && metadata.timestamp < oldestFile.timestamp) {
